...
urlpatterns = [
    ...
    path("ungraded_exercises_native", UngradedSpeakingExercisesListViewForLanguageNative.as_view()),
    path("graded_exercises_native", GradedSpeakingExercisesListViewForLanguageNative.as_view()),
    path("upcoming_exercises_native", UpcomingSpeakingExercisesListViewForLanguageNative.as_view()),
    path("past_exercises_native", PastSpeakingExercisesListViewForLanguageNative.as_view()),
    path("requested_exercises_native", RequestedSpeakingExercisesListViewForLanguageNative.as_view()),
    path("declined_exercises_native", DeclinedRequestedSpeakingExercisesListViewForLanguageNative.as_view()),
    path("accepted_exercises_native", AcceptedRequestedSpeakingExercisesListViewForLanguageNative.as_view()),
    ...
    path("upcoming_exercises_student", UpcomingSpeakingExercisesListAPIViewForStudent.as_view()),
    path("requested_exercises_student", RequestedSpeakingExercisesListAPIViewForStudent.as_view()),
    ...
    path("exercises_homeworks_student", ExerciseGradesListAPIViewForStudent.as_view()),
